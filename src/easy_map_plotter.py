...
class WorldMap:
    ...
    def __init__(self, default_color='#F5F5F5', ocean_color='white', border_color='#404040'):
    ...
    def _match_countries(self, country_list):
        ...
        all_matched = set(matched['NAME']) | set(matched['ISO_A3']) | set(matched['ISO_A2'])
    ...
    def plot(self, groups=None, figsize=(12, 7), title=None, show_legend=True):
        ...
        for group_name, (countries, color, label) in groups.items():
            ...
            handle = plt.Rectangle((0, 0), 1, 1, facecolor=color, edgecolor='none', label=label)
...
if __name__ == '__main__':
    ...
    gcbr = {'Australia', 'New Zealand', 'Norway', 'Sweden', 'Denmark', 'Finland',
            'Canada', 'Switzerland', 'Japan', 'KOR'}  # KOR = South Korea ISO code
