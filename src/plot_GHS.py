...
world_ghs = world.merge(
    ghs_data, left_on="country_match", right_on="Country", how="left"
)
...
plt.tight_layout()
plt.savefig(
    output_path / "global_health_security_index_map.png", dpi=300, bbox_inches="tight"
)
